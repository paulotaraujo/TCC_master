...
\begin{itemize}
  ...
  \item \texttt{receiver\_recommendation}: mapeamento dos canais de aquisição --- GPIO35 para tensão e GPIO34 para corrente ---, offsets, escalas em unidades de engenharia por volt, frequência e taxa de amostragem recomendada.
\end{itemize}
...
As saídas digitais destinadas ao painel indicam: bloqueio imposto pela supervisão 67; permissão direcional fornecida pela função 67; ocorrência de trip instantâneo; e ocorrência de trip temporizado. A indicação instantânea agrega 21/Z1, os estágios instantâneos de 27 e 59 e a função 50; a temporizada agrega 21/Z2, os estágios temporizados de 27 e 59 e a função 51. Há ainda LEDs para estado do sistema e presença de qualquer trip. A origem exata da atuação é identificada pelas mensagens seriais. A Figura \ref{fig:indicacao-leds} apresenta o painel empregado nos ensaios.
