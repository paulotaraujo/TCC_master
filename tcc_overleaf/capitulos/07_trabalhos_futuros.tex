...
\begin{itemize}
  \item \hl{expandir a reprodução e a aquisição para três tensões e três correntes, com pelo menos seis canais analógicos sincronizados, permitindo ensaios trifásicos, faltas assimétricas e cálculo de componentes simétricas;};
  \item \hl{avaliar cenários com eventos múltiplos, como faltas simultâneas ou combinações de falta, variação de tensão e alteração de carregamento, de modo a submeter a ESP32 a ensaios de estresse computacional e verificar sua capacidade de processamento, temporização, uso de memória e robustez dos algoritmos embarcados;};
  ...
  \item \hl{avaliar a prototipagem dos blocos de geração, aquisição e processamento em FPGA, ou em arquiteturas híbridas com microcontrolador e FPGA, permitindo maior paralelismo, sincronismo entre canais e capacidade de processamento para uma versão mais robusta da bancada; e}
